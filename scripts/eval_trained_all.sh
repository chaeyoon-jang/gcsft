...
MODEL_NAME="Llama-3.2-3B-Instruct"
BASE_MODEL_PATH="meta-llama/Llama-3.2-3B-Instruct"
OUTPUT_BASE_DIR="./logs/new_multi_csft"

CHECKPOINTS=(
    "/mnt/home/chaeyun-jang/gcsft/logs/Llama-3.2-3B-Instruct_csft_multi_seed0_lr1e-05_kl0.0_bs1_gs64_ms5000_ck0/checkpoint-1500"
)
