...
EVAL_FILE=${EVAL_FILE:-"data/processed/ruler_4k_train.jsonl"}
OUTPUT_DIR=${OUTPUT_DIR:-"./logs/qwen4/ruler_4k_seed_samples"}
...
output_file="${OUTPUT_DIR}/valid_base_argmax.jsonl"
